...
headers = {
  'requesting headers': {
    topic : function(){
      request.head(TEST_SERVER + '/2. Узлы DOM.html', this.callback);
    }
  }
}
...
.addBatch({
  ...
  'serving index.html from the cache': {
    topic : function(){
      request.get(TEST_SERVER + '/2. Узлы DOM.html', this.callback);
    },
    'should respond with 200' : function(error, response, body){
      assert.equal(response.statusCode, 200);
    },
  ...
  'requesting with If-None-Match': {
    topic : function(){
      var _this = this;
      request.get(TEST_SERVER + '/2. Узлы DOM.html', function(error, response, body){
        request({
          method: 'GET',
          uri: TEST_SERVER + '/2. Узлы DOM.html',
