...
if (mxClient.IS_VML)if (mxClient.IS_SVG)mxClient.IS_VML = !1; else {
...
var mxLog = {consoleName: "Console", TRACE: !1, DEBUG: !0, WARN: !0, buffer: "", init: function () {
    if (null == mxLog.window && null != document.body) {
        ...
        if ((mxClient.IS_NS || mxClient.IS_IE) && !mxClient.IS_GC && !mxClient.IS_SF && "BackCompat" != document.compatMode) {
            var f =
                mxLog.window.getElement(), a = function (a, b) {
...
var mxEffects = {animateChanges: function (a, b, c) {
            ...
            for (var g = !1, h = 0; h < b.length; h++) {
                ...
                if (k instanceof mxGeometryChange || k instanceof mxTerminalChange || k instanceof mxValueChange || k instanceof mxChildChange || k instanceof mxStyleChange) {
                    ...
                    if (null != l)if (g = !0, k.constructor != mxGeometryChange || a.model.isEdge(k.cell))mxUtils.setOpacity(l.shape.node, 100 * d / 10); else {
                        var m = a.getView().scale, n = (k.geometry.x - k.previous.x) * m, p = (k.geometry.y -
                            k.previous.y) * m, q = (k.geometry.width - k.previous.width) * m, m = (k.geometry.height - k.previous.height) * m;
    ...
    mxUtils = {errorResource: "none" != mxClient.language ? "error" : "", closeResource: "none" != mxClient.language ? "close" : "", errorImage: mxClient.imageBasePath + "/error.gif", removeCursors: function (a) {
        ...
        return 9 <= document.documentMode ?
            function (a, b, c) {
                var d = null;
                if (null != a)if (a.nodeType == mxConstants.NODETYPE_ELEMENT && a.getAttribute(b) == c)d = a; else for (a = a.firstChild; null != a && null == d;)d = mxUtils.findNodeByAttribute(a, b, c), a = a.nextSibling;
                return d
        ...
        toRadians: function (a) {
            ...
            f = 0 <= s ? s : 2 * Math.PI + s;
            s = Math.atan2((-l -
                q) / d, (-e - m) / c) - Math.atan2((l - q) / d, (e - m) / c);
            e = 0 <= s ? s : 2 * Math.PI + s;
            ...
            var d = -1;
            if (0 < a.absolutePoints.length)for (var e =
                a.absolutePoints[0], f = null, g = 1; g < a.absolutePoints.length; g++) {
            ...
            if (0 < d) {
                ...
                0 < m && (mxUtils.getValue(a.style,
                    mxConstants.STYLE_HORIZONTAL, !0) ? (h = a.y + m / 2, l = m) : (g = a.x + m / 2, k = m));
                k = Math.max(e, k * d);
                l = Math.max(e, l * d);
            ...
            for (var b = document.body, c = document.documentElement, d = new mxPoint(b.scrollLeft || c.scrollLeft, b.scrollTop || c.scrollTop); null != a && a != b && a != c;)!isNaN(a.scrollLeft) && !isNaN(a.scrollTop) && (d.x += a.scrollLeft, d.y += a.scrollTop), a = a.parentNode;
            return d
        ...
        cascadeOpacity: function (a, b, c) {
            ...
            if (null ==
                a || 0 == a.length)a = d || null == d ? b + "=" + c : b + "=0"; else {
                var e = a.indexOf(b + "=");
            ...
            b == mxConstants.ALIGN_MIDDLE ?
                d = -0.5 : b == mxConstants.ALIGN_BOTTOM && (d = -1);
            return new mxPoint(c, d)
            ...
            e.style.zoom = "1";
            null != d ? (e.style.width = d + "px",
                e.style.whiteSpace = "normal") : e.style.whiteSpace = "nowrap";
            e.innerHTML = a;
            ...
            a.dialect == mxConstants.DIALECT_SVG ? (f.drawPane = document.createElementNS(mxConstants.NS_SVG, "g"),
                f.canvas.appendChild(f.drawPane), f.overlayPane = document.createElementNS(mxConstants.NS_SVG, "g")) : (f.drawPane = f.drawPane.cloneNode(!1), f.canvas.appendChild(f.drawPane), f.overlayPane = f.overlayPane.cloneNode(!1));
            ...
            try {
                ...
                b.destroy(), f.translate = m, f.canvas.removeChild(f.drawPane), f.canvas.removeChild(f.overlayPane), f.drawPane = k, f.overlayPane =
                    l, f.setEventsEnabled(h)
            }
            return g
            ...
            if (mxClient.IS_IE) {
                ...
                null != a && (a.setAttribute("transform", "translate(" + c + "," + d + ")"), c = a.ownerSVGElement, c.setAttribute("width", e.width + Math.max(e.x, 0) + 3), c.setAttribute("height", e.height + Math.max(e.y, 0) + 3))
            }
        ...
        printScreen: function (a) {
            ...
            if (b) {
                ...
                c.appendChild(d);
                c = new mxWindow("Popup Window", c, document.body.clientWidth / 2 - 320, (document.body.clientHeight ||
                    document.documentElement.clientHeight) / 2 - 240, 640, 480, !1, !0);
                c.setClosable(!0);
                c.setVisible(!0)
            ...
            return a
        }}, mxConstants = {DEFAULT_HOTSPOT: 0.3, MIN_HOTSPOT_SIZE: 8, MAX_HOTSPOT_SIZE: 0, RENDERING_HINT_EXACT: "exact", RENDERING_HINT_FASTER: "faster", RENDERING_HINT_FASTEST: "fastest", DIALECT_SVG: "svg", DIALECT_VML: "vml", DIALECT_MIXEDHTML: "mixedHtml", DIALECT_PREFERHTML: "preferHtml", DIALECT_STRICTHTML: "strictHtml", NS_SVG: "http://www.w3.org/2000/svg", NS_XHTML: "http://www.w3.org/1999/xhtml", NS_XLINK: "http://www.w3.org/1999/xlink", SHADOWCOLOR: "gray", SHADOW_OFFSET_X: 2, SHADOW_OFFSET_Y: 3,
...
var mxEvent = {objects: [], addListener: function () {
    ...
    if (null != a) {
        var b = function (b) {
            ...
            var d = 0, d = mxClient.IS_FF ? -b.detail / 2 : b.wheelDelta / 120;
            0 != d && a(b, 0 < d)
        };
    ...
    return null != a.pointerType ? a.pointerType === a.MSPOINTER_TYPE_TOUCH : 0 == a.type.indexOf("touch")
}, isMouseEvent: function (a) {
    return null != a.pointerType ? a.pointerType === a.MSPOINTER_TYPE_MOUSE : 0 == a.type.indexOf("mouse")
    ...
    ("touchstart" ==
        a.type || "touchmove" == a.type) && null != a.touches && null != a.touches[0] ? a = a.touches[0] : "touchend" == a.type && (null != a.changedTouches && null != a.changedTouches[0]) && (a = a.changedTouches[0]);
    return a
...
var mxClipboard = {STEPSIZE: 10, insertCount: 1, cells: null, setCells: function (a) {
    mxClipboard.cells = a
}, getCells: function () {
    ...
    if (!mxClipboard.isEmpty()) {
        var b =
            a.getImportableCells(mxClipboard.getCells()), c = mxClipboard.insertCount * mxClipboard.STEPSIZE, d = a.getDefaultParent(), b = a.importCells(b, c, c, d);
...
mxWindow.prototype.installMinimizeHandler = function () {
    ...
    var a = !1, b = null, c = null, d = mxUtils.bind(this, function (d) {
        ...
        if (a)a = !1, this.minimize.setAttribute("src",
            this.minimizeImage), this.minimize.setAttribute("title", "Minimize"), this.contentWrapper.style.display = "", this.maximize.style.display = b, mxClient.IS_QUIRKS || (this.div.style.height = c), this.table.style.height = c, null != this.resize && (this.resize.style.visibility = ""), this.fireEvent(new mxEventObject(mxEvent.NORMALIZE, "event", d)); else {
            a = !0;
...
mxSession.prototype.encodeChanges = function (a, b) {
    for (var c = "", d = b ? -1 : 1, e = b ? a.length - 1 : 0; 0 <= e && e < a.length; e += d)var f = this.codec.encode(a[e]), c = c + mxUtils.getXml(f, this.linefeed);
    return c
};
...
function mxPanningManager(a) {
    ...
    this.mouseListener = {mouseDown: function (a, b) {
...
mxSvgCanvas2D.prototype.getSvgGradient = function (a, b, c, d, e) {
    ...
    if (null == g) {
        ...
        if (null != h)for (g = h.ownerDocument.getElementById(l); null != g && g.ownerSVGElement != h;)l = f + "-" + k++, g = h.ownerDocument.getElementById(l); else l = "id" + ++this.refCount;
...
mxVmlCanvas2D.prototype.createFill = function () {
    ...
    if (null != a.gradientColor) {
        ...
        var c = 180 - a.rotation, c = a.gradientDirection == mxConstants.DIRECTION_WEST ? c - (90 + ("x" == this.root.style.flip ? 180 : 0)) : a.gradientDirection == mxConstants.DIRECTION_EAST ? c + (90 + ("x" == this.root.style.flip ? 180 : 0)) : a.gradientDirection == mxConstants.DIRECTION_NORTH ? c - (180 + ("y" == this.root.style.flip ?
...
mxStencil.prototype.drawNode = function (a, b, c, d, e) {
    ...
    if ("save" == f)a.save(); else if ("restore" == f)a.restore(); else if ("path" == f) {
        a.begin();
        for (c = c.firstChild; null != c;)c.nodeType == mxConstants.NODETYPE_ELEMENT && this.drawNode(a, b, c, d, e), c = c.nextSibling
    } else if ("close" == f)a.close(); else if ("move" == f)a.moveTo(g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) * l); else if ("line" == f)a.lineTo(g + Number(c.getAttribute("x")) * k, h + Number(c.getAttribute("y")) *
...
mxShape.prototype.redraw = function () {
    ...
    this.checkBounds() ? (this.node.style.visibility = "", "DIV" == this.node.nodeName && this.isHtmlAllowed() ? this.redrawHtmlShape() : this.redrawShape(), this.updateBoundingBox()) : (this.node.style.visibility = "hidden", this.boundingBox = null)
};
...
mxShape.prototype.createVmlCanvas = function () {
    var a = 8 == document.documentMode && this.isParseVml() ? this.createVmlGroup() : this.node, b = new mxVmlCanvas2D(a, !1);
    if ("" != a.tagUrn) {
...
mxShape.prototype.paint = function (a) {
    ...
    if (null != this.stencil)this.paintStencilShape(a, c, d, e, f); else if (a.setStrokeWidth(this.strokewidth), null != this.points) {
        c = [];
...
mxRectangleShape.prototype.updateHtmlFilters = function (a) {
    ...
    if (this.gradient) {
        var c = this.fill, d = this.gradient, e = "0", f = {east: 0, south: 1, west: 2, north: 3}, g = null != this.direction ? f[this.direction] : 0;
...
mxText.prototype.updateBoundingBox = function () {
    ...
    if (!this.ignoreStringSize && null != a && "fill" != this.overflow && (!this.clipped || !this.ignoreClippedStringSize)) {
        ...
        if (null != a.ownerSVGElement)if (null != a.firstChild && null != a.firstChild.firstChild && "foreignObject" == a.firstChild.firstChild.nodeName)a = a.firstChild.firstChild,
            c = this.wrap ? this.bounds.width : parseInt(a.getAttribute("width")) * this.scale, d = parseInt(a.getAttribute("height")) * this.scale; else {
            b = a.getBBox();
            if (0 == b.width && 0 == b.height)return;
            this.boundingBox = new mxRectangle(b.x, b.y, b.width, b.height);
            b = 0
        } else d = null != this.state ? this.state.view.textDiv : null, null != this.offsetWidth && null != this.offsetHeight ? (c = this.wrap ? this.bounds.width : this.offsetWidth * this.scale, d = this.offsetHeight * this.scale) : null != d ? (this.updateFont(d), this.updateSize(d), mxUtils.isNode(this.value) ?
            d.innerHTML = this.value.outerHTML : (c = this.replaceLinefeeds ? this.value.replace(/\n/g, "<br/>") : this.value, d.innerHTML = c), c = this.wrap ? this.bounds.width : d.offsetWidth * this.scale, d = d.offsetHeight * this.scale) : (c = this.wrap ? this.bounds.width : a.offsetWidth * this.scale, d = a.offsetHeight * this.scale);
...
mxText.prototype.updateHtmlFilter = function () {
    ...
    var h =
        h * d, g = g * d, e = this.getTextRotation() * (Math.PI / 180), f = parseFloat(parseFloat(Math.cos(e)).toFixed(8)), k = parseFloat(parseFloat(Math.sin(-e)).toFixed(8)), e = e % (2 * Math.PI);
    0 > e && (e += 2 * Math.PI);
    e %= Math.PI;
    e > Math.PI / 2 && (e = Math.PI - e);
    var l = Math.cos(e), m = Math.sin(-e), b = g * -(b + 0.5), c = h * -(c + 0.5), n = (h - h * l + g * m) / 2 + k * b - f * c;
...
mxText.prototype.updateValue = function () {
    if (mxUtils.isNode(this.value))this.node.innerHTML = "", this.node.appendChild(this.value); else {
        ...
        if (null != b || null != c)if ("fill" == this.overflow || "width" == this.overflow)null !=
            b && (this.node.style.backgroundColor = b), null != c && (this.node.style.border = "1px solid " + c); else {
            var d = "";
...
mxText.prototype.updateSize = function (a) {
    var b = Math.round(this.bounds.width / this.scale), c = Math.round(this.bounds.height / this.scale), d = a.style;
...
mxImageShape.prototype.redrawHtmlShape = function () {
    ...
    this.node.innerHTML = "";
    if (null != this.image) {
        var a = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_BACKGROUND, ""), b = mxUtils.getValue(this.style, mxConstants.STYLE_IMAGE_BORDER, "");
...
mxLabel.prototype.init = function (a) {
    ...
    null != this.indicatorColor && null != this.indicatorShape && (this.indicator = new this.indicatorShape, this.indicator.dialect = this.dialect, this.indicator.bounds = this.bounds, this.indicator.fill = this.indicatorColor, this.indicator.stroke = this.indicatorColor, this.indicator.gradient = this.indicatorGradientColor, this.indicator.direction = this.indicatorDirection, this.indicator.init(this.node))
};
...
mxConnector.prototype.createMarker = function (a, b, c) {
    for (var d = b.length, e = c ? b[1] : b[d - 2], f = c ? b[0] : b[d - 1], g = 1; g < d - 1 && 0 == Math.round(e.x - f.x) && 0 == Math.round(e.y - f.y);)e = c ? b[1 + g] : b[d - 2 - g], g++;
    b = f.x - e.x;
    d = f.y - e.y;
    g = Math.max(1, Math.sqrt(b * b + d * d));
    e = b / g;
    b = d / g;
    d = mxUtils.getNumber(this.style, c ? mxConstants.STYLE_STARTSIZE : mxConstants.STYLE_ENDSIZE, mxConstants.DEFAULT_MARKERSIZE);
    g = mxUtils.getValue(this.style, c ? mxConstants.STYLE_STARTARROW : mxConstants.STYLE_ENDARROW);
    return mxMarker.createMarker(a, this, g, f, e, b,
...
mxStackLayout.prototype.moveCell = function (a, b, c) {
    ...
    if (null != a && null != e) {
        ...
        null != g && (b -= f ? g.x : g.y);
        for (g = 0; g < k; g++)if (c = d.getChildAt(e, g), c != a && (c = d.getGeometry(c), null != c)) {
...
mxStackLayout.prototype.execute = function (a) {
    if (null != a) {
        ...
        if (this.graph.isSwimlane(a)) {
            ...
            null != d && (k = h ? Math.min(k, d.height) : Math.min(k, d.width));
            b == h && (e -= k);
            h ? g += k : f += k
        }
        c.beginUpdate();
        try {
            for (var k = 0, h = null, l = c.getChildCount(a), m = 0; m < l; m++) {
                var n = c.getChildAt(a, m);
                if (!this.isVertexIgnored(n) && this.isVertexMovable(n)) {
                    var p = c.getGeometry(n);
                    if (null != p) {
                        p = p.clone();
                        if (null != this.wrap && null != h && (b && h.x + h.width + p.width + 2 * this.spacing > this.wrap || !b && h.y + h.height + p.height + 2 * this.spacing > this.wrap))h = null, b ? g += k + this.spacing : f += k + this.spacing, k = 0;
                        k = Math.max(k, b ? p.height : p.width);
                        null != h ? b ? p.x = h.x + h.width + this.spacing : p.y = h.y + h.height + this.spacing :
                            this.keepFirstLocation || (b ? p.x = f : p.y = g);
                        b ? p.y = g : p.x = f;
                        this.fill && null != e && (b ? p.height = e : p.width = e);
                        c.setGeometry(n, p);
                        h = p
                    }
                }
            }
            this.resizeParent && null != d && null != h && !this.graph.isCellCollapsed(a) ? (d = d.clone(), b ? d.width = h.x + h.width + this.spacing : d.height = h.y + h.height + this.spacing, c.setGeometry(a, d)) : this.resizeLast && (null != d && null != h) && (b ? h.width = d.width - h.x - this.spacing : h.height = d.height - h.y - this.spacing)
        } finally {
            c.endUpdate()
        }
    }
...
mxPartitionLayout.prototype.execute = function (a) {
    ...
    if (null != d) {
        ...
        f = e.length;
        if (0 < f) {
            var k = this.border, l = this.border, m = b ?
                d.height : d.width, m = m - 2 * this.border;
...
mxCircleLayout.prototype.execute = function (a) {
    ...
    try {
        for (var c = 0, d = null, e = null, f = [], g = b.getChildCount(a), h = 0; h < g; h++) {
            ...
            if (this.isVertexIgnored(k))this.isEdgeIgnored(k) || (this.resetEdges && this.graph.resetEdge(k), this.disableEdgeStyle && this.setEdgeStyleEnabled(k, !1)); else {
                f.push(k);
...
mxParallelEdgeLayout.prototype.layout = function (a) {
    var b = a[0], c = this.graph.getView(), d = this.graph.getModel(), e = d.getGeometry(c.getVisibleTerminal(b, !0)), d = d.getGeometry(c.getVisibleTerminal(b, !1));
    if (e == d)for (var b = e.x + e.width + this.spacing, c = e.y + e.height / 2, f = 0; f < a.length; f++)this.route(a[f], b, c), b += this.spacing; else if (null != e && null != d) {
        var b = e.x + e.width / 2, c = e.y + e.height / 2, f = d.x + d.width / 2 - b, g = d.y + d.height / 2 - c, d = Math.sqrt(f * f + g * g);
        if (0 < d) {
            e = g * this.spacing / d;
            d = f * this.spacing / d;
    ...
    for (d = 0; d < b.length; d++) {
        ...
        for (var f = 0; f < e.length; f++) {
            ...
            if (null != h && 0 < h.length) {
                ...
                c[d] == k && (k = a.getVisibleTerminal(h,
                    !0), k = mxCellPath.create(k), k = this.vertexMapper[k]);
...
mxGraphHierarchyModel.prototype.initialRank = function () {
    ...
    for (var e = a.slice(); 0 < a.length;) {
        ...
        if (h) {
            ...
            if (null != g)for (b = 0; b < g.length; b++)l = g[b], l.temp[0] = 5270620, l = l.target, -1 == l.temp[0] && (a.push(l), l.temp[0] = -2);
            a.shift()
        ...
        for (var h = 0; h < g.length; h++) {
            ...
            if (k != b[f] && a.graph.model.isVertex(k) && !a.isVertexIgnored(k)) {
                var l = a.getEdgesBetween(b[f],
                    k, !1), m = a.getEdgesBetween(b[f], k, !0), k = mxCellPath.create(l[0]);
...
mxSwimlaneModel.prototype.initialRank = function () {
    ...
    for (a.slice(); 0 < a.length;) {
        ...
        for (var g = !0, h = b[0], c = 0; c < e.length; c++) {
            var k = e[c];
            if (5270620 == k.temp[0])k = k.source, h = Math.min(h, k.temp[0] - 1); else {
                g = !1;
                break
            }
        }
        if (g) {
            ...
            d.temp[0] = h;
            if (null != f)for (c = 0; c < f.length; c++)k = f[c], k.temp[0] = 5270620, k = k.target, -1 == k.temp[0] && (a.push(k), k.temp[0] = -2);
            a.shift()
...
mxMedianHybridCrossingReduction.prototype.calculateRankCrossing = function (a, b) {
    ...
    for (h = 0; h < e; h++)for (k = 0; k < f; k++)if (201207 == g[h][k]) {
        for (d = h + 1; d < e; d++)for (l = 0; l < k; l++)201207 == g[d][l] && c++;
        for (d = 0; d < h; d++)for (l = k + 1; l < f; l++)201207 == g[d][l] &&
        c++
    }
    return c / 2
};
mxMedianHybridCrossingReduction.prototype.transpose = function (a, b) {
    for (var c = !0, d = 0; c && 10 > d++;)for (var e = 1 == a % 2 && 1 == d % 2, c = !1, f = 0; f < b.ranks.length; f++) {
        ...
        for (var n = m = l = null, p = null, q = null, s = null, r = null, t = null, u = null, v = null, k = 0; k < g.length - 1; k++) {
            ...
            for (var y = 0, z = 0, w = 0; w < q.length; w++)for (var x = 0; x < r.length; x++)q[w] > r[x] && y++, q[w] < r[x] && z++;
            for (w = 0; w < s.length; w++)for (x = 0; x < t.length; x++)s[w] > t[x] && y++, s[w] < t[x] && z++;
...
mxCoordinateAssignment.prototype.minNode = function (a) {
    ...
    for (f = 0; 0 < b.length && f <= a;) {
        var h = b.shift(), e = h.cell, k = h.weightedValue, l = parseInt(h.rankIndex), g = e.getNextLayerConnectedCells(k), m = e.getPreviousLayerConnectedCells(k), n = g.length, p = m.length, q = this.medianXValue(g, k + 1), s =
            this.medianXValue(m, k - 1), r = n + p, t = e.getGeneralPurposeVariable(k), u = t;
        0 < r && (u = (q * n + s * p) / r);
        n = !1;
...
mxCoordinateAssignment.prototype.rankMedianPosition = function (a, b, c) {
    ...
    for (f = 0; f < d.length; f++) {
        ...
        l = 0;
        p = 1E8;
        for (m = d[f].rankIndex + 1; m < d.length;)if (n = mxCellPath.create(b[m].getCoreCell()), n = e[n], null != n) {
            var q = n.cell;
            n.visited ?
            ...
            if (-1 < g && g < a.ranks.length && null != f && 0 < f.length) {
                ...
                for (var m = e.x[0] - e.width / 2, n = m + e.width, p = f = 0, g = [], l = 0; l < k.length; l++) {
                    ...
                    if (q.isVertex()) {
                        ...
                        for (var r = 0; r < s.length; r++)if (s[r].source == q || s[r].target == q)f += s[r].edges.length, p++, g.push(s[r])
...
mxCoordinateAssignment.prototype.setEdgePosition = function (a) {
    ...
    if (101207 != a.temp[0]) {
        ...
        for (var e = 0, f = mxCellPath.create(a.edges[0]), f = this.jettyPositions[f], g = a.isReversed ? a.target.cell : a.source.cell, h = this.layout.graph, k = 0; k < a.edges.length; k++) {
            ...
            m != g && (q = !q);
            if (null != f) {
                var s = q ? 2 : 0, r = q ? this.rankTopY[d] : this.rankBottomY[c],
                    t = f[4 * e + 1 + s];
                q && (t = -t);
                r += t;
                s = f[4 * e + s];
...
mxHierarchicalLayout.prototype.getEdges = function (a) {
    ...
    for (var c = this.graph.model, d = [], e = this.graph.isCellCollapsed(a), f = c.getChildCount(a), g = 0; g < f; g++) {
        var h = c.getChildAt(a, g);
        if (this.isPort(h))d = d.concat(c.getEdges(h, !0, !0)); else if (e || !this.graph.isCellVisible(h))d = d.concat(c.getEdges(h, !0, !0))
    }
    d = d.concat(c.getEdges(a, !0, !0));
    c = [];
    for (g = 0; g < d.length; g++)e = this.getVisibleTerminal(d[g], !0), f = this.getVisibleTerminal(d[g],
        !1), (e == f || e != f && (f == a && (null == this.parent || this.graph.isValidAncestor(e, this.parent, this.traverseAncestors)) || e == a && (null == this.parent || this.graph.isValidAncestor(f, this.parent, this.traverseAncestors)))) && c.push(d[g]);
...
mxHierarchicalLayout.prototype.traverse = function (a, b, c, d, e, f, g) {
    if (null != a && null != d) {
        ...
        if (null == d[h] && (null == g || null != g[h])) {
            ...
            for (c = 0; c < k.length; c++)if (h = this.getVisibleTerminal(k[c], !0) == a, !b || h)h = this.getVisibleTerminal(k[c], !h), e = this.traverse(h, b, k[c], d, e, f, g)
        } else if (null == e[h])for (c = 0; c < f.length; c++)if (a = f[c], null != a[h]) {
            for (k in e)a[k] = e[k];
            f.pop();
            return a
        }
...
mxSwimlaneLayout.prototype.updateGroupBounds = function () {
    ...
    for (e = 0; e < this.swimlanes.length; e++) {
        ...
        if (null != c) {
            var g = this.graph.getChildCells(f), d = this.graph.isSwimlane(f) ? this.graph.getStartSize(f) : new mxRectangle, f = this.graph.getBoundingBoxFromGeometry(g);
            b[e] = f;
            d = f.y + c.y - d.height -
                this.parentBorder;
            c = f.y + c.y + f.height;
    ...
    for (e = 0; e < this.swimlanes.length; e++)if (f = this.swimlanes[e], c = this.graph.getCellGeometry(f), null != c) {
        var g = this.graph.getChildCells(f), d = this.graph.isSwimlane(f) ? this.graph.getStartSize(f) : new mxRectangle, h = c.clone(), k = 0 == e ? this.parentBorder : this.interRankCellSpacing / 2;
        h.x += b[e].x - d.width - k;
...
mxSwimlaneLayout.prototype.getEdges = function (a) {
    ...
    d = d.concat(c.getEdges(a, !0, !0));
    c = [];
    for (g = 0; g < d.length; g++)e = this.getVisibleTerminal(d[g], !0), f = this.getVisibleTerminal(d[g], !1),
...
mxSwimlaneLayout.prototype.traverse = function (a, b, c, d, e, f, g, h) {
    if (null != a && null != d) {
        ...
        } else if (null == e[k])for (c = 0; c < f.length; c++)if (a = f[c], null != a[k]) {
            for (l in e)a[l] = e[l];
            f.pop();
            return a
        }
    ...
    try {
        for (var e = a.getChildCount(), f = 0; f < e; f++) {
            ...
            if ("function" == typeof g.getId) {
                var h = g.getId(), k = null != h && (!this.isEdge(g) || !c) ? this.getCell(h) : null;
                if (null == k) {
                    var l = g.clone();
                    l.setId(h);
...
var mxCellPath = {PATH_SEPARATOR: ".", create: function (a) {
    ...
    var q = c.x -
        k, s = c.y - l, q = e ? Math.atan2(q, s) : Math.atan2(s, q), r = e ? Math.atan2(h, a) : Math.atan2(a, h), s = !1, s = b == mxConstants.DIRECTION_NORTH || b == mxConstants.DIRECTION_WEST ? q > -r && q < r : q < -Math.PI + r || q > Math.PI - r, r = null;
...
mxPrintPreview.prototype.getDoctype = function () {
    var a = "";
    5 == document.documentMode ? a = '<meta http-equiv="X-UA-Compatible" content="IE=5">' : 8 == document.documentMode ? a = '<meta http-equiv="X-UA-Compatible" content="IE=8">' : 9 == document.documentMode && (a = '<meta http-equiv="X-UA-Compatible" content="IE=edge">');
    return a
};
mxPrintPreview.prototype.open = function (a) {
    ...
    try {
        ...
        if (null == this.wnd) {
            ...
            for (var t = this.getAppendices(this.pageFormat.width, this.pageFormat.height), r = 0; r < p; r++)for (var u = r * m / this.scale - this.y0 / this.scale + (f.y -
                k.y * g) / g, s = 0; s < n; s++) {
...
mxPrintPreview.prototype.writeHead = function (a, b) {
    ...
    mxClient.IS_VML && mxClient.link("stylesheet", mxClient.basePath + "/css/explorer.css", a);
...
mxPrintPreview.prototype.createPageSelector = function (a, b) {
    ...
    for (var e = c.createElement("tbody"), f = 0; f < a; f++) {
        for (var g = c.createElement("tr"), h = 0; h < b; h++) {
            var k = f * b + h + 1, l = c.createElement("td"), m = c.createElement("a");
...
mxPrintPreview.prototype.renderPage = function (a, b, c) {
    ...
    try {
        ...
        8 == document.documentMode && (d.style.position = "relative");
        var e = document.createElement("div");
        ...
        this.graph.dialect == mxConstants.DIALECT_VML && (e.style.position =
            "absolute");
        d.appendChild(e);
...
mxPrintPreview.prototype.addGraphFragment = function (a, b, c, d, e) {
    ...
    try {
        ...
        if (mxClient.IS_IE)d.overlayPane.innerHTML = ""; else for (c = e.firstChild; null != c;)q = c.nextSibling, b = c.nodeName.toLowerCase(), "svg" == b ? (c.setAttribute("width", parseInt(e.style.width)), c.setAttribute("height", parseInt(e.style.height))) : "default" != c.style.cursor && "table" != b && c.parentNode.removeChild(c), c = q;
    ...
    if (null != this.textDiv) {
        ...
        if (null == a)this.stopEditing(!0); else {
            var b = this.graph.isLabelClipped(a.cell), c = this.graph.isWrapping(a.cell), d = this.graph.getModel().isEdge(a.cell), e = this.graph.getView().scale, f = parseInt(a.style[mxConstants.STYLE_SPACING] || 0) * e, g = (parseInt(a.style[mxConstants.STYLE_SPACING_TOP] || 0) + mxText.prototype.baseSpacingTop) * e + f, h = (parseInt(a.style[mxConstants.STYLE_SPACING_RIGHT] || 0) + mxText.prototype.baseSpacingRight) *
                e + f, k = (parseInt(a.style[mxConstants.STYLE_SPACING_BOTTOM] || 0) + mxText.prototype.baseSpacingBottom) * e + f, e = (parseInt(a.style[mxConstants.STYLE_SPACING_LEFT] || 0) + mxText.prototype.baseSpacingLeft) * e + f, g = new mxRectangle(a.x, a.y, a.width - e - h, a.height - g - k), g = null != a.shape ? a.shape.getLabelBounds(g) : g;
...
mxCellEditor.prototype.getEditorBounds = function (a) {
    var b = this.graph.getModel().isEdge(a.cell), c = this.graph.getView().scale, d = this.getMinimumSize(a), e = d.width, d = d.height, f = parseInt(a.style[mxConstants.STYLE_SPACING] || 0) * c, g = (parseInt(a.style[mxConstants.STYLE_SPACING_TOP] || 0) + mxText.prototype.baseSpacingTop) * c + f, h = (parseInt(a.style[mxConstants.STYLE_SPACING_RIGHT] || 0) + mxText.prototype.baseSpacingRight) * c + f, k = (parseInt(a.style[mxConstants.STYLE_SPACING_BOTTOM] || 0) + mxText.prototype.baseSpacingBottom) *
        c + f, c = (parseInt(a.style[mxConstants.STYLE_SPACING_LEFT] || 0) + mxText.prototype.baseSpacingLeft) * c + f, h = new mxRectangle(a.x, a.y, Math.max(e, a.width - c - h), Math.max(d, a.height - g - k)), h = null != a.shape ? a.shape.getLabelBounds(h) : h;
...
mxCellRenderer.prototype.redrawLabel = function (a, b) {
    ...
    if (null == a.text && null != c && (mxUtils.isNode(c) || 0 < c.length))this.createLabel(a, c); else if (null != a.text && (null == c || 0 == c.length))a.text.destroy(), a.text = null;
    if (null != a.text) {
...
mxCellRenderer.prototype.redraw = function (a, b, c) {
    if (null != a.shape) {
        ...
        if (b || null == a.shape.bounds || a.shape.scale != a.view.scale || !a.shape.bounds.equals(a) || !mxUtils.equalPoints(a.shape.points,
            a.absolutePoints))d = !0, a.shape.points = null != a.absolutePoints ? a.absolutePoints.slice() : null, a.shape.bounds = new mxRectangle(a.x, a.y, a.width, a.height), a.shape.scale = a.view.scale, null == c || c ? a.shape.redraw() : a.shape.updateBoundingBox();
...
var mxEdgeStyle = {EntityRelation: function (a, b, c, d, e) {
    ...
    if (null != k)b = new mxCellState, b.x = k.x, b.y = k.y; else if (null != b) {
    ...
    var f = null !=
        d && 0 < d.length ? d[0] : null, g = !1, h = !1;
    if (null != b && null != c)if (null != f)var k = Math.min(b.x, c.x), l = Math.max(b.x + b.width, c.x + c.width), h = Math.min(b.y, c.y), m = Math.max(b.y + b.height, c.y + c.height), f = a.view.transformControlPoint(a, f), g = f.y < h || f.y > m, h = f.x < k || f.x > l; else k = Math.max(b.x, c.x), l = Math.min(b.x + b.width, c.x + c.width), g = k == l, g || (h = Math.max(b.y, c.y), m = Math.min(b.y + b.height, c.y + c.height), h = h == m);
    ...
    if (null == f[0] && null != b)for (; 1 < e.length && mxUtils.contains(b,
    ...
    if (null != d && 0 < d.length || g || f)mxEdgeStyle.SegmentConnector(a, b, c, d, e); else {
        ...
        d = null != b ? b.x : h.x;
        var g = null != b ? b.y : h.y, l = null != b ? b.width :
            1, m = null != b ? b.height : 1, n = null != c ? c.x : k.x, p = null != c ? c.y : k.y, q = null != c ? c.width : 1, s = null != c ? c.height : 1, f = a.view.scale * mxEdgeStyle.orthBuffer, r = [mxConstants.DIRECTION_MASK_ALL, mxConstants.DIRECTION_MASK_ALL];
        ...
        for (l = 0; 2 > l; l++)null != m && (b[l][0] = (m.x - d[l][0]) / d[l][2], 0.01 > b[l][0] ? a[l] = mxConstants.DIRECTION_MASK_WEST : 0.99 < b[l][0] && (a[l] = mxConstants.DIRECTION_MASK_EAST), b[l][1] = (m.y - d[l][1]) / d[l][3], 0.01 > b[l][1] ? a[l] = mxConstants.DIRECTION_MASK_NORTH : 0.99 < b[l][1] && (a[l] = mxConstants.DIRECTION_MASK_SOUTH)),
            m = null, null != c && (m = k);
        l = d[0][1] - (d[1][1] + d[1][3]);
        m = d[0][0] - (d[1][0] + d[1][2]);
        n = d[1][1] - (d[0][1] + d[0][3]);
        ...
        n > 2 * f && m > 2 * f && (0 < (h[0] & r[0]) && 0 < (k[1] & r[1]) ? (p[0][0] = h[0], p[0][1] = k[0], p[1][0] = k[1], p[1][1] = h[1], q = !0) : 0 < (k[0] & r[0]) && 0 < (h[1] & r[1]) && (p[0][0] = k[0], p[0][1] = h[0], p[1][0] = h[1], p[1][1] = k[1], q = !0));
        n > 2 * f && !q &&
        (p[0][0] = k[0], p[0][1] = h[0], p[1][0] = k[1], p[1][1] = h[1], q = !0);
        m > 2 * f && !q && (p[0][0] = h[0], p[0][1] = k[0], p[1][0] = h[1], p[1][1] = k[1]);
        for (l = 0; 2 > l; l++)if (0 == a[l] && (0 == (p[l][0] & r[l]) && (p[l][0] = p[l][1]), c[l] = p[l][0] & r[l], c[l] |= (p[l][1] & r[l]) << 8, c[l] |= (p[1 - l][l] & r[l]) << 16, c[l] |= (p[1 - l][1 - l] & r[l]) << 24, 0 == (c[l] & 15) && (c[l] <<= 8), 0 == (c[l] & 3840) && (c[l] = c[l] & 15 | c[l] >> 8), 0 == (c[l] & 983040) && (c[l] = c[l] & 65535 | (c[l] & 251658240) >> 8), a[l] = c[l] & 15, r[l] == mxConstants.DIRECTION_MASK_WEST || r[l] == mxConstants.DIRECTION_MASK_NORTH || r[l] ==
    ...
    for (var b in mxStyleRegistry.values)if (mxStyleRegistry.values[b] ==
        a)return b;
    return null
}};
...
mxGraphView.prototype.invalidate = function (a, b, c, d) {
    ...
    if (!a.invalidating) {
        a.invalidating = !0;
        if (b)for (var g = e.getChildCount(a), f = 0; f < g; f++) {
...
mxGraphView.prototype.validatePoints = function (a, b) {
    ...
    if (null != d) {
        if (d.invalid) {
            ...
            } else null != f && (f.relative && null != a && c.isEdge(a.cell)) && (f = this.getPoint(a, f), null != f && (d.x = f.x, d.y = f.y, f.x = f.x / this.scale - this.translate.x, f.y = f.y / this.scale - this.translate.y, d.origin = f, this.childMoved(a, d)));
            d.invalid = !1;
            b != this.currentRoot &&
            this.graph.cellRenderer.redraw(d, !1, this.isRendering())
        }
        if (c.isEdge(b) || c.isVertex(b))null != d.shape && null != d.shape.boundingBox && (e = d.shape.boundingBox.clone()), null != d.text && !this.graph.isLabelClipped(d.cell) && null != d.text.boundingBox && (null != e ? e.add(d.text.boundingBox) : e = d.text.boundingBox.clone())
    }
    if (null != d && (!this.graph.isCellCollapsed(b) || b == this.currentRoot)) {
        f = c.getChildCount(b);
...
mxGraphView.prototype.updatePoints = function (a, b, c, d) {
    if (null != a) {
        ...
        if (null != f)c = this.getTerminalPort(a, c, !0), d = this.getTerminalPort(a, d, !1), f(a, c, d, b, e); else if (null != b)for (f = 0; f < b.length; f++)null != b[f] && (d = mxUtils.clone(b[f]), e.push(this.transformControlPoint(a, d)));
        b = a.absolutePoints;
        e.push(b[b.length - 1]);
        a.absolutePoints = e
    }
...
mxGraphView.prototype.getState = function (a, b) {
    b = b || !1;
    var c = null;
    null != a && (c = this.states.get(a), this.graph.isCellVisible(a) && (null == c && b && this.graph.isCellVisible(a) ? (c = this.createState(a), this.states.put(a, c)) : b && (null != c && this.updateStyle) && (c.style = this.graph.getCellStyle(a))));
    return c
};
...
mxGraphView.prototype.installListeners = function () {
    ...
    if (null != b) {
        ...
        a.addMouseListener({mouseDown: function (b, c) {
...
mxGraph.prototype.getRemovedCellsForChanges = function (a) {
    for (var b = [], c = 0; c < a.length; c++) {
        var d = a[c];
        if (d instanceof mxRootChange)break; else d instanceof mxChildChange ? null != d.previous && null == d.parent && (b = b.concat(this.model.getDescendants(d.child))) : d instanceof mxVisibleChange && (b = b.concat(this.model.getDescendants(d.cell)))
    }
    return b
};
mxGraph.prototype.processChange = function (a) {
    if (a instanceof mxRootChange)this.clearSelection(), this.removeStateForCell(a.previous), this.resetViewOnRootChange && (this.view.scale = 1, this.view.translate.x = 0, this.view.translate.y = 0), this.fireEvent(new mxEventObject(mxEvent.ROOT)); else if (a instanceof mxChildChange) {
    ...
    } else a instanceof mxTerminalChange || a instanceof mxGeometryChange ? this.view.invalidate(a.cell) : a instanceof mxValueChange ? this.view.invalidate(a.cell, !1, !1) : a instanceof mxStyleChange ? (this.view.invalidate(a.cell, !0, !0, !1), this.view.removeState(a.cell)) : null != a.cell && a.cell instanceof mxCell && this.removeStateForCell(a.cell)
};
            ...
            if (null != h) {
                ...
                if (null != k && null != l) {
                    ...
                    if (this.model.isEdge(c[e])) {
                        ...
                        h = h.points;
                        if (null != h)for (k = 0; k < h.length; k++)h[k].x += m, h[k].y += l
                    } else h.x += m, h.y += l
                }
            }
        } else c = []
    ...
    if (null != a && 0 < a.length) {
        ...
        try {
            ...
            for (e = 0; e < a.length; e++) {
                for (var g = this.getConnections(a[e]), h = 0; h < g.length; h++)if (f = mxCellPath.create(g[h]), null == d[f]) {
                    var k = this.model.getGeometry(g[h]);
                    if (null != k) {
                        var l = this.view.getState(g[h]);
                        if (null != l) {
                            var k = k.clone(), m = l.getVisibleTerminal(!0) == a[e], n = l.absolutePoints, p = m ? 0 : n.length -
                                1;
...
mxGraph.prototype.zoom = function (a, b) {
    ...
    if (this.keepSelectionVisibleOnZoom && null != d)d = new mxRectangle(d.x * a, d.y * a, d.width * a, d.height * a), this.view.scale = c, this.scrollRectToVisible(d) || (this.view.revalidate(), this.view.setScale(c)); else if (b && !mxUtils.hasScrollbars(this.container)) {
        var d = this.container.offsetWidth, e = this.container.offsetHeight;
        if (1 < a)var f = (a - 1) / (2 * c), d = d * -f, e = e * -f; else f = (1 / a - 1) / (2 * this.view.scale),
            d *= f, e *= f;
...
mxGraph.prototype.getCellAt = function (a, b, c, d, e) {
    ...
    if (null != c)for (var f = this.model.getChildCount(c) - 1; 0 <= f; f--) {
        ...
        if (null != h)return h;
        if (this.isCellVisible(g) && (e && this.model.isEdge(g) || d && this.model.isVertex(g)))if (h = this.view.getState(g), this.intersects(h, a, b))return g
    }
    return null
};
...
mxGraph.prototype.getEdges = function (a, b, c, d, e, f) {
    ...
    h = [];
    for (l = 0; l < g.length; l++)m = this.view.getState(g[l]), k = null != m ? m.getVisibleTerminal(!0) : this.view.getVisibleTerminal(g[l], !0), m = null != m ? m.getVisibleTerminal(!1) : this.view.getVisibleTerminal(g[l],
        !1), (e && k == m || k != m && (c && m == a && (null == b || this.isValidAncestor(k, b, f)) || d && k == a && (null == b || this.isValidAncestor(m, b, f)))) && h.push(g[l]);
    return h
};
...
mxGraph.prototype.getPointForEvent = function (a, b) {
    var c = mxUtils.convertPoint(this.container, mxEvent.getClientX(a), mxEvent.getClientY(a)), d = this.view.scale, e = this.view.translate, f = !1 != b ? this.gridSize / 2 : 0;
...
mxGraph.prototype.getCells = function (a, b, c, d, e, f) {
    ...
    if (0 < c || 0 < d) {
        ...
        if (null != e)for (var k = this.model.getChildCount(e), l = 0; l < k; l++) {
...
mxGraph.prototype.getCellsBeyond = function (a, b, c, d, e) {
    var f = [];
    if (d || e)if (null == c && (c = this.getDefaultParent()), null != c)for (var g = this.model.getChildCount(c), h = 0; h < g; h++) {
...
mxGraph.prototype.isEventIgnored = function (a, b, c) {
    ...
    !mxEvent.isPopupTrigger(this.lastEvent) && mxClient.IS_IE && "CSS1Compat" ==
        document.compatMode && a != mxEvent.MOUSE_MOVE && 2 == b.getEvent().detail ? null != this.lastMouseX && (Math.abs(this.lastMouseX - b.getX()) <= this.doubleTapTolerance && null != this.lastMouseY && Math.abs(this.lastMouseY - b.getY()) <= this.doubleTapTolerance) && (e = !0) : !mxEvent.isPopupTrigger(this.lastEvent) && (a != mxEvent.MOUSE_MOVE && 2 == this.lastEvent.detail) && (e = !0);
    if (a == mxEvent.MOUSE_UP && this.isMouseDown)this.isMouseDown = !1; else if (a == mxEvent.MOUSE_DOWN && !this.isMouseDown)this.isMouseDown = !0, this.isMouseTrigger = d; else if (!e &&
        ((!mxClient.IS_FF || a != mxEvent.MOUSE_MOVE) && this.isMouseDown && this.isMouseTrigger != d || a == mxEvent.MOUSE_DOWN && this.isMouseDown || a == mxEvent.MOUSE_UP && !this.isMouseDown))e = !0;
...
mxGraph.prototype.fireMouseEvent = function (a, b, c) {
    ...
    if (!this.nativeDblClickEnabled && !mxEvent.isPopupTrigger(b.getEvent()) || this.doubleTapEnabled && mxClient.IS_TOUCH && mxEvent.isTouchEvent(b.getEvent())) {
        ...
        if (this.isEnabled())if (!mxClient.IS_QUIRKS && a == mxEvent.MOUSE_DOWN || mxClient.IS_QUIRKS && a == mxEvent.MOUSE_UP && !this.fireDoubleClick) {
            if (null != this.lastTouchEvent && this.lastTouchEvent != b.getEvent() && d - this.lastTouchTime < this.doubleTapTimeout && Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance && 2 > this.doubleClickCounter) {
                ...
                a == mxEvent.MOUSE_UP ? b.getCell() == this.lastTouchCell && null != this.lastTouchCell && (this.lastTouchTime = 0, a = this.lastTouchCell, this.lastTouchCell = null, this.dblClick(b.getEvent(), a)) : (this.fireDoubleClick = !0, this.lastTouchTime = 0);
            ...
            (null != a || mxEvent.isTouchEvent(b.getEvent()) && (mxClient.IS_GC || mxClient.IS_SF)) &&
                Math.abs(this.lastTouchX - b.getX()) < this.doubleTapTolerance && Math.abs(this.lastTouchY - b.getY()) < this.doubleTapTolerance ? this.dblClick(b.getEvent(), a) : mxEvent.consume(b.getEvent());
            return
        }
    }
    if (!this.isEventIgnored(a, b, c)) {
        ...
        if (mxClient.IS_OP || mxClient.IS_SF || mxClient.IS_GC || mxClient.IS_IE && mxClient.IS_SVG || b.getEvent().target != this.container) {
            a == mxEvent.MOUSE_MOVE && (this.isMouseDown && this.autoScroll) && this.scrollPointToVisible(b.getGraphX(),
                b.getGraphY(), this.autoExtend);
...
mxOutline.prototype.update = function (a) {
    if (null != this.source) {
        ...
        if (0 < e) {
            ...
            var c = d.translate, e = this.source.getView().scale,
                f = e / d.scale, g = 1 / d.scale, h = this.source.container;
...
mxOutline.prototype.mouseDown = function (a, b) {
    if (this.enabled && this.showViewport) {
        var c = !mxEvent.isMouseEvent(b.getEvent()) ? this.source.tolerance : 0, c = this.source.allowHandleBoundsCheck && (mxClient.IS_IE || 0 < c) ? new mxRectangle(b.getGraphX() - c, b.getGraphY() - c, 2 * c, 2 * c) : null;
...
mxOutline.prototype.mouseMove = function (a, b) {
    if (this.active) {
        ...
        if (this.zoom)c = this.source.container, e = d / (c.clientWidth / c.clientHeight), c = new mxRectangle(this.bounds.x, this.bounds.y, Math.max(1, this.bounds.width + d), Math.max(1, this.bounds.height + e)), this.selectionBorder.bounds = c, this.selectionBorder.redraw(); else {
            var f =
                this.outline.getView().scale, c = new mxRectangle(this.bounds.x + d, this.bounds.y + e, this.bounds.width, this.bounds.height);
    ...
    if (!b.isConsumed() && c.isMouseDown && null != this.cell && null != this.first && null != this.bounds) {
        ...
        if (null != this.shape || Math.abs(e) > d || Math.abs(f) > d) {
            ...
            var g = c.isGridEnabledEvent(b.getEvent()),
                d = !0;
            if (null != this.guide && this.useGuidesForEvent(b))f = this.guide.move(this.bounds, new mxPoint(e, f), g), d = !1, e = f.x, f = f.y; else if (g)var h = c.getView().translate, k = c.getView().scale, g = this.bounds.x - (c.snap(this.bounds.x / k - h.x) + h.x) * k, h = this.bounds.y - (c.snap(this.bounds.y / k - h.y) + h.y) * k, f = this.snap(new mxPoint(e, f)), e = f.x - g, f = f.y - h;
            ...
            null != e && null == g && (h.getParent(this.cell) != d || k) ? (this.target != d && (this.target = d, this.setHighlightColor(mxConstants.DROP_TARGET_COLOR)), l = !0) : (this.target = null, this.connectOnDrop && (null != f && 1 == this.cells.length && c.getModel().isVertex(f) &&
                c.isCellConnectable(f)) && (e = c.getView().getState(f), null != e && (c = null == c.getEdgeValidationError(null, this.cell, f) ? mxConstants.VALID_COLOR : mxConstants.INVALID_CONNECT_TARGET_COLOR, this.setHighlightColor(c), l = !0)));
            null != e && l ? this.highlight.highlight(e) : this.highlight.hide()
        }
        b.consume();
        mxEvent.consume(b.getEvent())
    } else if ((this.isMoveEnabled() || this.isCloneEnabled()) && this.updateCursor && !b.isConsumed() && null != b.getState() && !c.isMouseDown)e = c.getCursorForCell(b.getCell()), null == e && (c.isEnabled() && c.isCellMovable(b.getCell())) &&
        (e = c.getModel().isEdge(b.getCell()) ? mxConstants.CURSOR_MOVABLE_EDGE : mxConstants.CURSOR_MOVABLE_VERTEX), b.getState().setCursor(e)
};
...
function mxPanningHandler(a) {
    null != a && (this.graph = a, this.graph.addMouseListener(this), this.forcePanningHandler = mxUtils.bind(this, function (a, c) {
        var d = c.getProperty("eventName"), e = c.getProperty("event");
...
mxConnectionHandler.prototype.createMarker = function () {
    ...
    a.getCell = mxUtils.bind(this, function (b, c) {
        ...
        var d = this.graph.view.scale, d = new mxPoint(this.graph.snap(b.getGraphX() / d) * d, this.graph.snap(b.getGraphY() / d) * d);
        this.error = null;
    ...
    if (!b.isConsumed() && (this.ignoreMouseDown || null != this.first || !this.graph.isMouseDown)) {
        ...
        if (null != this.first) {
            ...
            if (null != this.edgeState) {
                ...
                (g = this.getTargetPerimeterPoint(this.currentState, b), null != g && (e = g)), null == this.sourceConstraint && null != this.previous && (g = this.getSourcePerimeterPoint(this.previous, null != this.waypoints && 0 < this.waypoints.length ? this.waypoints[0] : e, b), null != g && (f = g));
...
mxConstraintHandler.prototype.update = function (a, b) {
    if (this.isEnabled() && !this.isEventIgnored(a)) {
        ...
        if (null == this.currentFocusArea || !mxUtils.intersects(this.currentFocusArea, d) || null != a.getState() && null != this.currentFocus && e)if (this.currentFocusArea = null, a.getState() != this.currentFocus)if (this.currentFocus = null, this.constraints = null != a.getState() && e && !this.isStateIgnored(a.getState(),
...
function mxRubberband(a) {
    null != a && (this.graph = a, this.graph.addMouseListener(this), this.forceRubberbandHandler = mxUtils.bind(this, function (a, c) {
        ...
        if (d == mxEvent.MOUSE_DOWN && this.isForceRubberbandEvent(e)) {
            var d = mxUtils.getOffset(this.graph.container), f = mxUtils.getScrollOrigin(this.graph.container);
            f.x -= d.x;
            f.y -= d.y;
...
mxVertexHandler.prototype.getHandleForEvent = function (a) {
    ...
    var c = !mxEvent.isMouseEvent(a.getEvent()) ? this.tolerance : 1, d = this.allowHandleBoundsCheck && (mxClient.IS_IE || 0 < c) ? new mxRectangle(a.getGraphX() - c, a.getGraphY() - c, 2 * c, 2 *
        c) : null, e = null, c = null;
    if (null != this.sizers)for (var f = 0; f < this.sizers.length; f++)b(this.sizers[f]) && (c = f);
...
mxVertexHandler.prototype.mouseMove = function (a, b) {
    if (!b.isConsumed() && null != this.index) {
        ...
        if (!this.inTolerance) {
            ...
            if (this.index == mxEvent.LABEL_HANDLE)d && (c.x = this.graph.snap(c.x / e) * e, c.y = this.graph.snap(c.y / e) * e), this.moveSizerTo(this.sizers[this.sizers.length - 1], c.x, c.y); else if (this.index == mxEvent.ROTATION_HANDLE) {
    ...
    if (null != this.index && null != this.state) {
        ...
        try {
            if (this.index == mxEvent.ROTATION_HANDLE) {
                ...
                var e = this.graph.isGridEnabledEvent(b.getEvent()), f = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"), g = Math.cos(-f), h =
                    Math.sin(-f), k = c.x - this.startX, l = c.y - this.startY, c = h * k + g * l, k = g * k - h * l, l = c, m = this.graph.view.scale;
    ...
    if (c.isVertex(a)) {
        ...
        if (this.state.cell != a && (d = this.graph.getCellGeometry(a), null != d && !d.relative && 0 != b)) {
            ...
            if (!d.relative && null != f) {
                var g = mxUtils.toRadians(b), e = Math.cos(g), g = Math.sin(g),
                    h = new mxPoint(d.getCenterX(), d.getCenterY()), f = new mxPoint(f.width / 2, f.height / 2), e = mxUtils.getRotatedPoint(h, e, g, f), d = d.clone();
                d.x = e.x - d.width / 2;
                d.y = e.y - d.height / 2;
                c.setGeometry(a, d)
            }
...
mxVertexHandler.prototype.resizeCell = function (a, b, c, d, e) {
    ...
    if (null != f)if (d == mxEvent.LABEL_HANDLE)d = this.graph.view.scale, b = (this.labelShape.bounds.getCenterX() - this.startX) / d, c = (this.labelShape.bounds.getCenterY() - this.startY) / d, f = f.clone(), null == f.offset ? f.offset = new mxPoint(b, c) : (f.offset.x += b, f.offset.y += c), this.graph.model.setGeometry(a, f); else {
...
mxVertexHandler.prototype.union = function (a, b, c, d, e, f, g) {
    ...
    if (0 == d || 3 == d || 5 == d)h += b, e && (h = this.graph.snap(h / f) * f); else if (2 == d || 4 == d || 7 == d)k += b, e && (k = this.graph.snap(k / f) * f);
    e = k - h;
    a -=
        l;
...
mxVertexHandler.prototype.redrawHandles = function () {
    ...
    if (null != this.sizers) {
        ...
        if (this.singleSizer)this.moveSizerTo(this.sizers[0], b, c); else {
            var d = a.x + a.width / 2, e = a.y + a.height /
                2;
            if (1 < this.sizers.length) {
                var f = "nw-resize n-resize ne-resize e-resize se-resize s-resize sw-resize w-resize".split(" "), g = mxUtils.toRadians(this.state.style[mxConstants.STYLE_ROTATION] || "0"), h = Math.cos(g), k = Math.sin(g), g = Math.round(4 * g / Math.PI), l = new mxPoint(a.getCenterX(), a.getCenterY()), m = mxUtils.getRotatedPoint(new mxPoint(a.x, a.y), h, k, l);
...
mxEdgeHandler.prototype.createMarker = function () {
    ...
    a.getCell = function (a) {
        var d = mxCellMarker.prototype.getCell.apply(this, arguments), e = b.getPointForEvent(a);
...
mxEdgeHandler.prototype.getHandleForEvent = function (a) {
    ...
    var c = !mxEvent.isMouseEvent(a.getEvent()) ? this.tolerance : 1, d = this.allowHandleBoundsCheck && (mxClient.IS_IE || 0 < c) ? new mxRectangle(a.getGraphX() - c, a.getGraphY() - c, 2 * c, 2 * c) :
        null, e = null, c = null;
    if (a.isSource(this.state.text) || b(this.labelShape))c = mxEvent.LABEL_HANDLE;
    if (null != this.bends)for (var f = 0; f < this.bends.length; f++)b(this.bends[f]) && (c = f);
    return c
};
...
mxEdgeHandler.prototype.getPointForEvent = function (a) {
    ...
    if (this.snapToTerminals && 0 < c) {
        ...
        if (null != this.abspoints)for (h = 0; h < this.abspoints; h++)h != this.index && g.call(this, this.abspoints[h])
    }
...
mxEdgeHandler.prototype.mouseUp = function (a, b) {
    if (null != this.index && null != this.marker) {
        ...
        if (b.getX() != this.startX || b.getY() != this.startY)if (null != this.error)0 < this.error.length && this.graph.validationAlert(this.error); else if (this.isLabel)this.moveLabel(this.state, this.label.x, this.label.y); else if (this.isSource || this.isTarget) {
            ...
            if (null != d)c = this.connect(c, d, this.isSource, this.graph.isCloneEvent(b.getEvent()) && this.cloneEnabled && this.graph.isCellsCloneable(), b); else if (this.graph.isAllowDanglingEdges()) {
...
mxEditor.prototype.createLayoutManager = function (a) {
    ...
    b.getLayout = function (b) {
        ...
        if (null != f.getParent(b))if (c.layoutSwimlanes && a.isSwimlane(b))null == c.swimlaneLayout && (c.swimlaneLayout = c.createSwimlaneLayout()), e = c.swimlaneLayout; else if (c.layoutDiagram && (a.isValidRoot(b) || null == f.getParent(f.getParent(b))))null == c.diagramLayout && (c.diagramLayout = c.createDiagramLayout()), e = c.diagramLayout;
        return e
    };
    return b
};
...
mxEditor.prototype.showProperties = function (a) {
    ...
    if (null != a) {
        ...
        if (null != this.properties && !this.movePropertiesDialog)c = this.properties.getX(), b = this.properties.getY(); else {
...
mxEditor.prototype.showHelp = function (a) {
    if (null == this.help) {
        ...
        a = document.body.clientWidth;
        var c = document.body.clientHeight || document.documentElement.clientHeight, d = new mxWindow(mxResources.get(this.helpResource) || this.helpResource, b, (a - this.helpWidth) / 2, (c - this.helpHeight) /
        ...
        if (null != a && null != h) {
            ...
            if (null != k) {
                if (c -= k.origin.x * f, d -= k.origin.y * f, this.graph.isConstrainedMoving) {
                    var h =
                        g.width, l = g.height, m = k.x + k.width;
                    c + h > m && (c -= c + h - m);
                    m = k.y + k.height;
                    d + l > m && (d -= d + l - m)
                }
...
mxCodecRegistry.register(function () {
    ...
    a.afterEncode = function (a, c, d) {
        if (null != c.value && c.value.nodeType == mxConstants.NODETYPE_ELEMENT) {
            var e = d;
            d = mxClient.IS_IE ? c.value.cloneNode(!0) : a.document.importNode(c.value,
                !0);
            d.appendChild(e);
            a = e.getAttribute("id");
            d.setAttribute("id", a);
    ...
    a.beforeDecode = function (a, c, d) {
        ...
        if (null != e)for (c = 0; c < this.idrefs.length; c++) {
            var f =
                this.idrefs[c], g = e.getAttribute(f);
            if (null != g) {
                e.removeAttribute(f);
        ...
        if (null == g || null != f) {
            ...
            if (null != l) {
                ...
                if (null == g) {
                    ...
                    for (n in f.style)g = f.style[n], "function" == typeof g && "object" == typeof g && (g = mxStyleRegistry.getName(g)), null != g && ("function" != typeof g && "object" != typeof g) && m.setAttribute(n, g);
                    g = f.absolutePoints;
            ...
            for (c = c.firstChild; null != c;) {
                if (c.nodeType == mxConstants.NODETYPE_ELEMENT && !this.processInclude(a, c, d))if ("separator" == c.nodeName)d.addSeparator(); else if ("br" == c.nodeName)d.toolbar.addBreak(); else if ("hr" == c.nodeName)d.toolbar.addLine(); else if ("add" == c.nodeName) {
                    var f = c.getAttribute("as"), f = mxResources.get(f) || f, g = c.getAttribute("icon"),
                        h = c.getAttribute("pressedIcon"), k = c.getAttribute("action"), l = c.getAttribute("mode"), m = c.getAttribute("template"), n = "0" != c.getAttribute("toggle"), p = mxUtils.getTextContent(c), q = null;
        ...
        for (a = c.firstChild; null != a;) {
            if ("add" == a.nodeName) {
                ...
                if (null != e)g = document.getElementById(e), null != g && null != f && (g.style.cssText += ";" + f); else {
                    var e = parseInt(a.getAttribute("x")), h = parseInt(a.getAttribute("y")), k = a.getAttribute("width"), l = a.getAttribute("height"),
