...
$key1 = null; $mean1 = null;
foreach($ar1 as $key1=>$mean1) {
    echo "Ключ $key1, значение $mean1<br>";
}

// перемещение по значениям массива с помощью фукнцкий current, next, prev
echo reset($ar1)."<br>"; // сначала сбросим курсор массива


echo current($ar1)."<br>";  //  'John'
echo key($ar1)."<br>";
echo next($ar1)."<br>";     // 'Michael'
echo current($ar1)."<br>";  // 'Michael'
echo prev($ar1)."<br>";     // 'John'
echo end($ar1)."<br>";      // 'Garry'
echo reset($ar1)."<br>";    // 'John'
