...
function WebmailViewModel() {
    ...
    // 5. Создать функцию-обработчик для события click
		...
		self.goToFolder = function(foldersItem, event) {
			...
			self.chosenFolderId(foldersItem);
			...
			// - Сохранить полученные данные в свойства chosenFolderData.
				...
				if(foldersItem == 'Inbox') {
					self.chosenFolderData({
						mails: [
							{id: 1, folder: 'Inbox', from: 'Иван1', to: 'Пётр1', subject: 'Тема1', date: '20.08.2014'},
							{id: 2, folder: 'Inbox', from: 'Иван2', to: 'Пётр2', subject: 'Тема2', date: '19.08.2014'},
							{id: 3, folder: 'Inbox', from: 'Иван3', to: 'Пётр3', subject: 'Тема3', date: '18.08.2014'}
						]
					});
 				}

				if(foldersItem == 'Archive') {
					self.chosenFolderData({
						mails: [
							{id: 4, folder: 'Archive', from: 'Иван4', to: 'Пётр4', subject: 'Тема4', date: '20.08.2014'},
							{id: 5, folder: 'Archive', from: 'Иван5', to: 'Пётр5', subject: 'Тема5', date: '19.08.2014'},
							{id: 6, folder: 'Archive', from: 'Иван6', to: 'Пётр6', subject: 'Тема6', date: '18.08.2014'}
						]
					});
 				}
				...
				if(foldersItem == 'Sent') {
					self.chosenFolderData({
						mails: [
							{id: 7, folder: 'Sent', from: 'Иван7', to: 'Пётр7', subject: 'Тема7', date: '20.08.2014'},
							{id: 8, folder: 'Sent', from: 'Иван8', to: 'Пётр8', subject: 'Тема8', date: '19.08.2014'},
							{id: 9, folder: 'Sent', from: 'Иван9', to: 'Пётр9', subject: 'Тема9', date: '18.08.2014'}
						]
					});
 				}
				...
				if(foldersItem == 'Spam') {
					self.chosenFolderData({
						mails: [
							{id: 10, folder: 'Spam', from: 'Иван10', to: 'Пётр10', subject: 'Тема10', date: '20.08.2014'},
							{id: 11, folder: 'Spam', from: 'Иван11', to: 'Пётр11', subject: 'Тема11', date: '19.08.2014'},
							{id: 12, folder: 'Spam', from: 'Иван12', to: 'Пётр12', subject: 'Тема12', date: '18.08.2014'}
						]
					});
 				}
		...
		// 7. Сделать inbox выбранной по умолчанию при старте
		...
		self.goToMail = function(mail, event) {
			...
			// Присвоить св-ву chosenFolderId значение mail.folder
